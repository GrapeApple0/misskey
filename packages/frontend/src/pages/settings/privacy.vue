...
const defaultNoteVisibility = ref($i.defaultNoteVisibility);
const defaultNoteLocalOnly = ref($i.defaultNoteLocalOnly);
const defaultRenoteVisibility = ref($i.defaultRenoteVisibility);
const defaultRenoteLocalOnly = ref($i.defaultRenoteLocalOnly);
const rememberNoteVisibility = ref($i.rememberNoteVisibility);
const keepCw = ref($i.keepCw);
